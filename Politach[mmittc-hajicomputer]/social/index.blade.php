...
@section('title','Icon Lists')
@section('page-header')
    <i class="fa fa-list"></i> Icons Lists
@stop
@section('css')
...
@section('content')
    ...
    <div class="page-header">
        ...
        <a class="btn btn-xs btn-info blue" href="{{ route('createicon') }}" role="button"
            data-toggle="modal" style="float: right; margin: 0 2px;">
                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover" >
                    ...
                    @foreach($icons as $key=>$icon)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('updateicon',$icon->id) }}" class="btn btn-sm btn-primary" title="Edit">
                                    <i class="fa fa-edit"></i>
                                </a>

                                <button class="btn btn-xs btn-danger" title="Delete" 
                                        onclick="delete_check('{{ route('deleteicon', $icon->id) }}')" type="button">
                                    <i class="fa fa-trash"></i>
                                </button>
                                
                                {{--  <a class="btn btn-sm btn-danger" title="Delete" onclick="delete_check({{ $icon->id }})" 
