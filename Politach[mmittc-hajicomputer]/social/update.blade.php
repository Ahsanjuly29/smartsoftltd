        ...
        <div class="col-sm-8 col-sm-offset-2">
            <div class="widget-box">
                <div class="widget-header">
                    <h4 class="widget-title"> @yield('page-header')
                        <a href="{{ route('iconview') }}" style="float: right; margin-right: 20px;">Icon Lists</a>
                    </h4>
                </div>
                ...
                <div class="widget-body">
                    ...
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST"
                            action="{{route('updateiconpost')}}"  enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="form-field-1-1" placeholder="ex.facebook" 
                                    name="name" class="form-control" value="{{ old('name')?? $item->name }}" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="form-field-1-1" placeholder="ex. https://www.youtube.com/" 
                                    name="link" class="form-control" value="{{ old('link')?? $item->link }}" />
                                    @error('link')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="form-field-1-1" placeholder="ex. fa fa-youtube-play" 
                                    name="icon" class="form-control" value="{{ old('icon')?? $item->icon }}" />
                                    @error('icon')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    name="color" value="{{ old('color')?? $item->color }}" id="form-field-1-1" />
                                    @error('color')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
